...
const Game: React.FC = () => {
  ...
  <p>You Win if:</p>
  <ul>
    <li>The House’s total is 21 and your total is less than 21 (for the purposes of this project, you can ignore this condition, since the House will only have two cards and cannot get a total > 21)</li>
